[{capture append="oxidBlock_content"}]
  ...
  <a class="readMore" href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=cc_account_tickets" params="ticket=new"}]" rel="nofollow">+ [{ oxmultilang ident="CC_TICKETSYSTEM_NEW_TICKET" }]</a>
